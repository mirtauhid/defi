import { Button, Card, CardBody, Heading, useModal } from '@saltswap/uikit'
    ...
    if (!allowance.toNumber()) {
      return (
        <Button fullWidth disabled={requestedApproval} onClick={handleApprove}>
          {TranslateString(494, 'Approve OWL')}
        </Button>
      )
    }
    return (
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/ticket.svg" alt="owl logo" width={64} height={64} />
        <Block>
          <Label>{TranslateString(552, 'OWL to Collect')}:</Label>
          <CakeWinnings />
        </Block>
        <Block>
